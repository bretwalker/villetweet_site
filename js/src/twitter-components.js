 /** @jsx React.DOM */
    ...
    var Tweet = React.createClass({
        render: function() {
            ...
            return (
                ...
                <span className="tweetScreenName" dangerouslySetInnerHTML={{__html: username}} />
                </div>
            );
        }
    });
    ...
    var TweetListControl = React.createClass({
        ...
        render: function() {
            ...
            return (
                <span onClick={this.handleClick} className="firehoseControl">{text}</span>
            );
        }
    });
    ...
    var NavItem = React.createClass({
        ...
        render: function() {
            ...
            return (
                <li onClick={this.setNavSelection} className={classes}>{this.props.name}</li>
            );
        }
    });
