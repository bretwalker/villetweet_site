 /** @jsx React.DOM */
        ...
        render: function() {
            ...
            return (
                React.DOM.ul(null, 
                    ...
                    " else ", 
                        React.DOM.li({className: classes}, this.props.name)
    ...
    var App = React.createClass({displayName: 'App',
        ...
        render: function() {
            ...
            navs = [Nav({currentPage: this.state.currentPage, setNavSelection: this.setNavSelection, navItems: navItems})];
            if(_this.props.currentPage in ['prolific', 'mentioned', 'hashtag'])
            {
                Nav({currentPage: this.state.days, setNavSelection: this.setSubNavSelection, navItems: subNavItems})
            }
