 /** @jsx React.DOM */
    ...
    var twitterNameRegexReplace = '$1<a href="http://twitter.com/$2">@$2</a>';
    ...
    var Tweet = React.createClass({displayName: 'Tweet',
        render: function() {
            ...
            var text = minEmoji(this.props.text);
            text = text.replace(twitterNameRegex, twitterNameRegexReplace);
            
            return (
                React.DOM.div({className: "tweet", dangerouslySetInnerHTML: {__html: text}}
                )
            );
        }
    });
